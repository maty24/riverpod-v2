      ...
      body: Center(
        ...
        children: [
          ...
          TextButton.icon(
            ...
            onPressed: () {
              //le pongo notifer para notificar el cambio
              ref
                  .read(counterProvider.notifier)//notifico al provider
                  .increseByOne(); //el ultimo . es que estoy llamando la funcion del state
            },
          ),
          const Spacer(flex: 2),
        ],
